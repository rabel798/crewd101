...
class RegisterForHackathonView(LoginRequiredMixin, View):
    ...
    def get(self, request, hackathon_id, group_id):
        return self.handle_registration(request, hackathon_id, group_id)
        
    def post(self, request, hackathon_id, group_id):
        return self.handle_registration(request, hackathon_id, group_id)
        
    def handle_registration(self, request, hackathon_id, group_id):
